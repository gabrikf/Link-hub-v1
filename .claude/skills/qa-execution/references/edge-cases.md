...
| Visit a nonexistent profile | `/profile/definitely-not-a-user` | 404 UX, recovery links, whether it leaks whether the username exists |
...
| Share a profile link | Send `/profile/<username>` to a logged-out reader | What a stranger sees; whether anything private renders |
