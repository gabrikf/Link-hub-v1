...
flowchart TD
    ...
    G --> H[True end: a logged-out reader sees the post on /profile/diego
...
| `J-share-public-profile` | A stranger with a link learns enough in 30 seconds, signed out, on a phone | Sam (Mobile / cold reader) | `/profile/<username>` |
