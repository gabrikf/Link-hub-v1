...
name: qa-report
description: >-
  Plans real-user QA for LinkHub as living repo docs — the durable
...
- **i18n** — the *planned* internationalisation setup. LinkHub has none today; consult it only to avoid writing plans that assume `t()` calls exist.
