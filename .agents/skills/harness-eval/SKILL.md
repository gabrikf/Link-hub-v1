...
metadata:
  ...
  version: 1.8.3+crafthub.1
---

# Harness Eval

> **This repo's copy is a local fork.** Its Python scripts were fixed on
> 2026-09-04: directory cites, elisions, workspace-relative resolution,
> workspace manifests, nested-checkout pruning, four-digit claim IDs, and a
> per-claim/per-surface JSON band output the claim ledger reads. Re-installing
> the upstream skill over this directory reintroduces a Track A that reports
> ~48 false BROKEN here. See `docs/harness/agent-harness.md`.
