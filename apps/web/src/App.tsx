  ...
  return (
    <div className="relative min-h-screen bg-zinc-100 text-zinc-900 transition-colors dark:bg-zinc-950 dark:text-zinc-100">
      ...
      >
        ...
        <span
          className={`inline-flex h-8 w-8 items-center justify-center rounded-full bg-violet-700 text-white transition-transform duration-200 dark:bg-violet-500 sm:h-7 sm:w-7 ${theme === "dark" ? "translate-x-[2.75rem]" : "translate-x-0"}`}
        >
          {theme === "dark" ? (
            <FiMoon className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
          ) : (
